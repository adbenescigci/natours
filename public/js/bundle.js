...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJkdWxsYWhjaWdjaSIsImEiOiJja3Y2ZWJ0M2sxZmFhMm9zM2h3MDhreWFjIn0.Vp7MAduuWSFSo8zgPM2Ksg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/abdullahcigci/ckv6k72we7opt14l9zxdtp7br',
    scrollZoom: false //   center: [-118.031517, 33.997584],
    //   zoom: 8,
    //   interactive:false
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\"0> ").concat(msg, " </div>");
...
exports.signup = exports.activate = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your request was sent your email succesfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var activate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(jwt) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:8000/api/v1/users/activateAccount/".concat(jwt)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your account was activated');
              window.setTimeout(function () {
                location.assign('/');
              }, 2500);
            }
...
var stripe = Stripe('pk_test_51JxolwAmLsVuaSBDUrKRXLfAmvePHzx7mwGdM5IxbhdTpjGFbYouurSZT0edurcLF4YsWerm0FGcQw7PZd7jAPuZ00oUZlTCgq');
...
var activateAccount = document.querySelector('.form--activate');
...
if (activateAccount) {
  var jwt = activateAccount.dataset.jwt;
  (0, _signup.activate)(jwt);
}
